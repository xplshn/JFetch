...
// jfetch is a clone of [fet.sh](https://raw.githubusercontent.com/eepykate/fet.sh/master/fet.sh)
package main
...
func main() {
	printInfo := func(label, value string) {
		if value != "" {
			fmt.Printf("\x1b[0m\x1b[34m%6s\x1b[0m ~ %s\n", label, value)
		}
	}
	...
	fmt.Printf("\x1b[0m\x1b[34m%6s\x1b[0m\n", sysInfo.Host)
